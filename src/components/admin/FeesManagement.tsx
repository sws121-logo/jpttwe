...
const FeesManagement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const total = formData.tuition_fee + formData.admission_fee + formData.examination_fee + 
                 formData.library_fee + formData.laboratory_fee + formData.other_fees;
    // We don't update formData here to avoid infinite loop
  }, [formData]);
